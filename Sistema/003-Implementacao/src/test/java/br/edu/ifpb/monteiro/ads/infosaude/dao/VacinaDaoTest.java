...
public class VacinaDaoTest {
    ...
    public void loteDuplicadoTest() {
        ...
        vacina.setLote("123");
        vacina.setNome("123");
        vacina.setQuantidadeDosesRecebidas(3);
