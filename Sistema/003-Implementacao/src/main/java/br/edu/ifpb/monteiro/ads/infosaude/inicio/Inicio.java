...
//        pacienteDao.salvar(paciente);
        PacienteServiceIF pacienteService = new PacienteService();
        paciente = pacienteService.consultarPorId(50L);
//
//        // nome, cnpj
        Fornecedor fornecedor = new Fornecedor();
//        fornecedor.setNome("Teste");
//        fornecedor.setCnpj("123456789098765");
        FornecedorServiceIF fornecedorService = new FornecedorService();
        fornecedor = fornecedorService.consultarPorId(39L);
//
...
//        vacina.setNumeroLote("123");
        VacinaServiceIF vacinaService = new VacinaServie();
        vacina = vacinaService.consultarPorId(42L);
//
//        // cnes, nome, numero
...
//        vacinador.setRegistroCoren(23130);
//        vacinador.setFuncionario(funcionario);
        VacinadorServiceIF vacinadorService = new VacinadorService();
//        vacinadorService.salvar(vacinador);
        vacinador = vacinadorService.consultarPorId(37L);
